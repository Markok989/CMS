...
const courses = [
    {
        ...
        category: "JavaScript", //kursevi 1.1 // 
        detailes: [
            {
                // drugi deo  lekcija thumbnail
                id: "javascript-building-applications",
                lessonTitle: "test Building Applications in JavaScript", //kurs 2.1 //
                lessonList: [
                    {
                        lesID: "2",
                        lesTitle: "Module 1: Overview", // poglavlje kursa 2.2 //
                        chapters: [{
                            // spisak lekcija poglavlja kursa  2.3 // 
                        }]
                    },
                    {
                        lesID: "2",
                        lesTitle: "Module 2: Overview",
                        chapters: [{
